...
> Het priemgetallen-onderzoek (IQ-spel, `priemvondsten`/`mega_priemen`, de
> `priem-claim`-function) is uit productie gehaald. IQ blijft bestaan als een
> rustend, aangeboren cijfer (`b.iq`, `PARTNER_IQ_GEWICHT`) maar wordt niet meer
> verdiend.
